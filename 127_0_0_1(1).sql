...
--
CREATE DATABASE IF NOT EXISTS `blaise_ndahayo_cas_lms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `blaise_ndahayo_cas_lms`;
...
('root', '[{\"db\":\"blaise_ndahayo_cas_lms\",\"table\":\"admin\"}]');
...
('root', '2024-02-19 10:37:41', '{\"Console\\/Mode\":\"collapse\"}');
